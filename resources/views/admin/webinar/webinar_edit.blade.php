          ...
          <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    <a href="{{route('webinar.list')}}" class="btn btn-primary">Back</a>
                </div>
            </div>
              <div class="card-body">
                  <form class="form-horizontal mt-5" role="form" method="POST" action="{{ route('webinar.update',$webinar->id)}}" enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-10">
                              <input type="text" id="title" name="webinar_title" placeholder="Webinar Title" class="form-control" value="{{$webinar->webinar_title}}">
                              @error('webinar_title')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input type="date" id="web_start_date" class="form-control" name="webinar_start_date" value="{{$webinar->webinar_start_date}}">
                          ...
                          <div class="col-md-4">
                              <input type="time" id="web_start_time" class="form-control" name="webinar_start_time" value="{{$webinar->webinar_start_time}}">
                              @error('webinar_start_time')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input type="date" id="web_end_date" class="form-control" name="webinar_end_date" value="{{$webinar->webinar_end_date}}">
                              @error('webinar_end_date')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                          <label for="end_time" class="form-label col-md-2">End Time</label>
                          <div class="col-md-4">
                              <input type="time" id="web_end_time" class="form-control" name="webinar_end_time" value="{{$webinar->webinar_end_time}}">
                              @error('webinar_end_time')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                      </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-4">
                              <input type="text" id="name" name="speaker_name" placeholder="Speaker Name" class="form-control" value="{{$webinar->speaker_name}}">
                              @error('speaker_name')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="mb-2">
                                <img src="{{ asset('upload/webinar/' . $webinar->speaker_image) }}" alt="Speaker Image" class="img-fluid" style="max-height: 100px; max-width: 100px;">
                            </div>
                            @endif
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-10">
                              <textarea class="form-control" id="about" name="about_speaker" rows="8">{{$webinar->about_speaker}}</textarea>
                              @error('about_speaker')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                          </div>
                      ...
                      <div class="row mb-3 align-items-center" id="price_section" style="display: none;">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="webinar_price" placeholder="Price" class="form-control" value="{{$webinar->webinar_price}}">
                            @error('webinar_price')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3 align-items-center" id="gst_section" style="display: none;">
                      ...
                      <div class="row mb-3 align-items-center" id="web_address_section" style="display: none;">
                        ...
                        <div class="col-md-6">
                            <input type="text" name="webinar_address" id="web_add" class="form-control" value="{{$webinar->webinar_address}}">
                            @error('webinar_address')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div class="row mb-3 align-items-center" id="web_link_section" style="display: none;">
                        ...
                        <div class="col-md-6">
                            <input type="text" id="webinar_link" placeholder="Webinar Link" class="form-control" name="webinar_link" value="{{$webinar->webinar_link}}">
                            @error('webinar_link')
                            <span class="text-danger">{{$message}}</span>
                            @enderror
                        </div>
                      ...
                      <div class="row mb-3">
                          ...
                          <div class="col-md-10">
                              <textarea class="form-control" id="web_desc" rows="8" name="webinar_description">{{$webinar->webinar_description}}</textarea>
